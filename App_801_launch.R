...
#
# The last line of the response should be "Listening on ...", e.g. http://127.0.0.1:6178
...
#
# Alternative: open R or RStudio
#  setwd("C:/Data/seksjon 212/Milkys2_pc")
#  - and then the two sentences below
