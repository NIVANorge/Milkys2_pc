...
Make a couple of csv files for the R Markdown / Git course
...
write.csv(dat_sel2, "Files_for_other_use/Milkys_individual_data_selection.csv", 
          row.names = FALSE, fileEncoding = "UTF-8")
write.csv(dat_median, "Files_for_other_use/Milkys_median_data_selection.csv", 
          row.names = FALSE, fileEncoding = "UTF-8")

if (FALSE){
  dat_sel2 <- read.csv("Files_for_other_use/Milkys_individual_data_selection.csv", encoding = "UTF-8")
  dat_median <- read.csv("Files_for_other_use/Milkys_median_data_selection.csv", encoding = "UTF-8")
}
