...
xtabs(~is.na(Uncertainty), dat_all %>% filter(MYEAR == selected_year))

if (FALSE)
  xtabs(~PARAM + Lab, dat_all %>% filter(MYEAR == selected_year & is.na(Uncertainty)))
...
xtabs(~is.na(Uncertainty), dat_all_updated %>% filter(MYEAR == selected_year))
