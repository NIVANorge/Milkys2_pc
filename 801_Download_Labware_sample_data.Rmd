...
if (FALSE){
  ...
  filename <- paste0("Labware_samples_2020_", file_date, ".rds")
  saveRDS(labware_2020, paste0("Files_to_Jupyterhub_2020/", filename))
  cat("File", sQuote(filename), "saved for 2020 \n")
  
}

filename <- paste0("Labware_samples_2021_", file_date, ".rds")
saveRDS(labware_2021, paste0("Files_to_Jupyterhub_2021/", filename))
