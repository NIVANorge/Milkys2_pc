...
# 2021 data - NOTE: HARD-CODED
dat_2021 <- dat %>%
  filter(grepl("2021", TEXT_ID))
...
prosj <- unique(dat_2021$PROSJEKT)
cat("Name of project", prosj, " \n\n")

#
# Approach a
# 
labware_2021_a <- get_nivabase_selection(
  "*",
  "LABWARE_CHECK_SAMPLE", 
  "TEXT_ID",
  dat_2021$TEXT_ID, values_are_text = TRUE)

#
# Approach b
# 
search_string <- paste(
  "select * from NIVADATABASE.LABWARE_CHECK_SAMPLE where PROSJEKT =", sQuote(prosj)
)

labware_2021_b <- get_nivabase_data(search_string) %>%
  mutate(PROSJEKT = oracle_fix_norw_letters(PROSJEKT),
         DESCRIPTION = oracle_fix_norw_letters(DESCRIPTION)
         )
...
table(labware_2021_a$AQUAMONITOR_CODE)
table(labware_2021_b$AQUAMONITOR_CODE)

# 
# Use approach b
#
labware_2021 <- labware_2021_b
