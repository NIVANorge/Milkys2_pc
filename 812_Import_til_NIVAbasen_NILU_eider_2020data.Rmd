...
- Here we just modfy the values in place, using 
...
SET FLAG1 = '<' WHERE VALUE_ID >= 2004793 and VALUE_ID <= 22006914 and VALUE < 0;

UPDATE NIVADATABASE.BIOTA_CHEMISTRY_VALUES
SET VALUE = (-VALUE) WHERE VALUE_ID >= 2004793 and VALUE_ID <= 22006914 and VALUE < 0;
